...
export default function LiveStreamPlayer({
  ...
  return (
    <div className="videojs-container">
      <div data-vjs-player>
        <video ref={videoRef} className="video-js vjs-theme-forest vjs-big-play-centered" data-setup="{}">
      ...
      {hasError ? (
        <div className="videojs-error">
          ...
          <div className="error-actions">
            <button onClick={retryStream} className="retry-button">
              Retry Stream
            </button>
            <button onClick={() => window.open(src, "_blank")} className="open-tab-button">
              Open in New Tab
            </button>
          </div>
